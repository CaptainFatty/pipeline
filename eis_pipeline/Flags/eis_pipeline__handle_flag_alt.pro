...
pro eis_pipeline::handle_flag_alt, flag ;no_soda=no_soda, no_fetch=no_fetch, fetch_only=fetch_only, no_split=no_split
  self->trace, 'eis_pipeline::handle_flag_alt'
